...
<div align="center">
  <img src="./public/logo.svg" alt="FrameLedger — PC game performance — Pacing" width="64" height="64">
  <h1>FrameLedger — PC game performance — Pacing</h1>
</div>

An independent project specification for PC game performance, covering frame-time csv import, percentile comparison table, benchmark condition manifest.
...
<img src="./public/screenshots/desktop-main.svg" alt="PC game performance — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="PC game performance — compact concept, not a screenshot" width="250">
<br>
...
- **Frame-time CSV import** — planned module; not implemented.
- **Percentile comparison table** — planned module; not implemented.
- **Benchmark condition manifest** — planned module; not implemented.

The proposed workflow separates frame-time csv import from percentile comparison table, with benchmark condition manifest retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Frame-time CSV import**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="FrameLedger — PC game performance — Pacing — specification review workflow">
<br>
...
### Frame-time CSV import

Define the input and expected outcome for module 1. Record the PC game performance version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Percentile comparison table

Define the input and expected outcome for module 2. Record the PC game performance version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Benchmark condition manifest

Define the input and expected outcome for module 3. Record the PC game performance version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | PC game performance |
| Category | PC utility specification |
| Input | Manual notes or user-authorized local exports |
| Planned output | Frame-time CSV import |
