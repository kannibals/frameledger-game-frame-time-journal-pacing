# Verification plan — PC game performance

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Frame-time CSV import

- [ ] Define a versioned input fixture specifically for frame-time csv import.
...
### 2. Percentile comparison table

- [ ] Define a versioned input fixture specifically for percentile comparison table.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Benchmark condition manifest

- [ ] Define a versioned input fixture specifically for benchmark condition manifest.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
